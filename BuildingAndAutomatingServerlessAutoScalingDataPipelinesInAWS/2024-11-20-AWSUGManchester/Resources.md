...
- [amazonwebshark: WordPress AWS Data Pipeline (2024: Ongoing)](https://amazonwebshark.com/projects/#wordpress-aws-data-pipeline-2024-ongoing)
...
- [Introducing an enhanced in-console editing experience for AWS Lambda](https://aws.amazon.com/blogs/compute/introducing-an-enhanced-in-console-editing-experience-for-aws-lambda/)
- [Python 3.13 runtime now available in AWS Lambda](https://aws.amazon.com/blogs/compute/python-3-13-runtime-now-available-in-aws-lambda/)

## Amazon S3
- [Amazon S3 Storage Classes](https://aws.amazon.com/s3/storage-classes/)
- [Amazon Simple Storage Service endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/s3.html)
...
- [Amazon EventBridge Scheduler endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/eventbridgescheduler.html)
...
- [Build an AWS CodeBuild Project (CodeBuild, Amazon SNS)](https://docs.aws.amazon.com/step-functions/latest/dg/sample-project-codebuild.html)
- [Tune a Machine Learning Model](https://docs.aws.amazon.com/step-functions/latest/dg/sample-hyper-tuning.html)

- [Announcing Infrastructure as Code template generation for AWS Step Functions](https://aws.amazon.com/about-aws/whats-new/2024/11/infrastructure-code-template-generation-aws-step-functions/)
